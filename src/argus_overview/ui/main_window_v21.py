...
class MainWindowV21(QMainWindow):
    ...
    def _create_menu_bar(self):
        ...
        handlers = {
            ...
            "documentation": lambda: self._open_url("https://github.com/AreteDriver/Argus_Overview_Windows#readme"),
            "report_issue": lambda: self._open_url("https://github.com/AreteDriver/Argus_Overview_Windows/issues"),
        }
