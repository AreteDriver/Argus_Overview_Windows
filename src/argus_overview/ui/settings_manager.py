...
class SettingsManager:
    ...
    DEFAULT_SETTINGS = {
        ...
        "advanced": {
            "log_level": "INFO",
            "config_directory": "%LOCALAPPDATA%\\Argus-Overview",
            "enable_debug": False
        }
    }
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        ...
        Args:
            config_dir: Configuration directory path (default: %LOCALAPPDATA%\\Argus-Overview)
        """
        self.logger = logging.getLogger(__name__)

        if config_dir is None:
            import os
            config_dir = Path(os.environ.get('LOCALAPPDATA', Path.home())) / 'Argus-Overview'
